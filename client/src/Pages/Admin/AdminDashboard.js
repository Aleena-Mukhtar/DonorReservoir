      ...
      <div className='mainContent'>
        <div className="leftPanel">
          <div className='BtnDiv'>
            <button className={btnClick === 1 ? 'btn click' : 'btn'} onClick={navigateToBottleStockPage}>Details of Bottles</button>
            <button className={btnClick === 2 ? 'btn click' : 'btn'} onClick={(e) => setBtnClick(2)}>Patient Requests</button>
            <button className={btnClick === 3 ? 'btn click' : 'btn'} onClick={(e) => setBtnClick(3)}>Blood Bank</button>     
          </div>
            ...
            <table className='table'>
              <thead className='tableHeader'>
                <th className='headText' align='left'>
                  {
                    btnClick === 2 ? 'Patient Blood Requests' : 'Blood Bank Notifications'
                  }
                </th>
              </thead>
              <tbody className='tableBody'>
                <tr className='eachRow' onClick={btnClick === 2 ? navigateToEachPatientPage : navigateToEachBankPage}>
                  <td className='rowText' align='center'>
                    <div>
                      {
                        btnClick === 2 ? 'Patient with ID 123456 Requested for Blood Bottle(s)' : 'You got a reply From Aleena Donations Bank'
                      }
                    </div>
