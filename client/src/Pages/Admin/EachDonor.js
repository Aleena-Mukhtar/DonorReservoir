...
import { MdOutlineAccessTimeFilled, MdEmail, MdBloodtype } from 'react-icons/md';
    ...
    <div className='eachDonor'>
        <div className='topDiv'>
            ...
            <div className='imgDiv'>
                {donor[0]?.img === "" ? (
                    ...
                    <img src={donor[0]?.img} alt="logo" className="donor-img" />
                )}
            </div>
        </div>
        <div className='MainContent'>
            <div className='nameDiv'>
                <div className='name'>{donor[0]?.fname} {donor[0]?.lname}</div>
            ...
            <div className='rightPanel'>
                <div className='DetailCon'>
                    ...
                    <div className='text'>{donor[0]?._id}</div>
                </div>
                <div className='DetailCon'>
                    <div className='header'>
                        <BsCalendar2DateFill className='icon'/>
                    </div>
                    <div className='text'>{new Date(donor[0]?.createdAt.toString()).toDateString()}</div>
                </div>
                <div className='DetailCon'>
                    <div className='header'>
                ...
                <div className='DetailCon'>
                    ...
                    <div className='text'>{donor[0]?.address}</div>
                </div>
                <div className='DetailCon'>
                    <div className='header'>
                        <HiIdentification className='icon colorIcon'/>
                    </div>
                    <div className='text'>{donor[0]?.CNIC}</div>
                </div>
                <div className='DetailCon'>
                    <div className='header'>
                        <BsTelephoneOutboundFill className='icon'/>
                    </div>
                    <div className='text'>{donor[0]?.phone}</div>
                </div>
                <div className='DetailCon'>
                    <div className='header'>
                        <BsTelephoneOutboundFill className='icon colorIcon'/>
                    </div>
                    <div className='text'>{donor[0]?.phone2}</div>
                </div>
                <div className='DetailCon'>
                    <div className='header'>
                        <MdEmail className='icon'/>
                    </div>
                    <div className='text'>{donor[0]?.email}</div>
                </div>
                <div className='DetailCon'>
                    <div className='header'>
                        <MdBloodtype className='icon colorIcon'/>
                    </div>
                    <div className='text'>{donor[0]?.bloodType}</div>
                </div>
            </div>
        </div>
        <div className='logoutModal' style={{display: showDeleteModal ? 'flex' : 'none'}} onClick={(e) => setShowDeleteModal(false)}>
            <div className='logout'>
                ...
                <div className='innerHeading'>Are you sure you want to delete this donor's data?</div>
                <div className='btnCon'>
                    <button className='cancelBtn' onClick={(e) => setShowDeleteModal(false)}>Cancel</button>
                    <button className='okBtn' onClick={handleDelete}>OK</button>
                </div>
            </div>
        </div>
    </div>
