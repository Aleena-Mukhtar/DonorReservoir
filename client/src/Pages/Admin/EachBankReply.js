    ...
    <div className='eachBankReply'>
        ...
        </div>
        {
            ...
            <div className='btnCon1'>
                <button className='RBtn' onClick={(e) => setShowDenyModal(!showDenyModal)}>Reject</button>
                <button className='ABtn' onClick={(e) => setStatus('accept')}>Accept</button>
            </div> : null
        }
        ...
        <div className='logoutModal' style={{display: showDenyModal ? 'flex' : 'none'}} onClick={(e) => setShowDenyModal(false)}>
            <div className='logout'>
                ...
                <div className='btnCon'>
                    ...
                    <button className='okBtn' onClick={(e) => setStatus('reject')}>OK</button>
                </div>
            </div>
        </div>
    </div>
